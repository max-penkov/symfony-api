 ...
 */
final class Version20200422075710 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_9474526CF675F31B ON comment (author_id)');
        $this->addSql('CREATE INDEX IDX_9474526CA77FBEAF ON comment (blog_post_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, username, password, name, roles, password_change_date, email FROM user');
        ...
        , password_change_date INTEGER DEFAULT NULL, email VARCHAR(255) NOT NULL)');
        $this->addSql('INSERT INTO user (id, username, password, name, roles, password_change_date, email) SELECT id, username, password, name, roles, password_change_date, email FROM __temp__user');
